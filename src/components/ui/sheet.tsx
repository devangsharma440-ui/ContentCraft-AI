...
export function SheetContent({ className, children, side = 'right', ...props }: SheetContentProps) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div
        className={cn(
          'fixed inset-y-0 z-50 flex w-3/4 max-w-sm flex-col gap-4 border-l bg-background p-6 shadow-lg',
      ...
      >
        <button
          className={cn('absolute top-4 opacity-70 hover:opacity-100', isLeft ? 'right-4' : 'left-4')}
